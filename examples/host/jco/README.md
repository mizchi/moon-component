...
moon-component componentize \
  examples/tests/types-test/_build/wasm/release/build/src/src.wasm \
  --wit-dir examples/tests/types-test/wit \
  -o examples/tests/types-test/types-test.component.wasm
```
