...
swift run SwiftHost ../../tests/types-test/_build/wasm/release/build/src/src.wasm
...
- For component-level testing (with full canonical ABI), use the Rust host in `../rust`
